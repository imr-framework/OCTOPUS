...
from OCTOPUS.utils.fieldmap.fieldmap_gen import fieldmap_bin
...
# Inputs
raw_data = sio.loadmat(os.path.abspath(inputs['path_rawdat_acr_noncart']))['dat']
...
field_map = np.load(os.path.abspath(inputs['path_fieldmap']))
